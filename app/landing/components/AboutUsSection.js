...
export default function AboutUsSection({ isVisible }) {
  return (
    <section id="about" className="bg-gradient-to-b from-blue-50 to-white py-12 md:py-20 relative overflow-hidden">
          ...
          <div className="lg:w-1/2">
            ...
            >
              ...
              <p className="text-gray-600 mb-6 text-base md:text-lg leading-relaxed">
                En AdoptaTuMascota, creemos que cada mascota merece un hogar lleno de amor y cada persona merece la
                compañía de un amigo fiel. No somos un refugio, sino un puente que conecta a los animales rescatados con
                familias dispuestas a brindarles un hogar.
              </p>
              ...
              >
                <div className="bg-gradient-to-r from-orange-500 to-orange-400 text-white p-3 md:p-4 rounded-lg mr-4 shadow-md">
                  <span className="font-bold text-sm md:text-base">¡GRACIAS!</span>
                </div>
                <div>
                  <span className="text-orange-500 font-bold text-2xl md:text-3xl block">100+</span>
                  <span className="text-orange-500 text-sm md:text-base">Familias felices</span>
                </div>
              </motion.div>
            </motion.div>
          </div>
          ...
          <div className="lg:w-1/2 w-full">
            ...
            >
              ...
              >
                ...
                <span className="text-white text-sm md:text-base">Adopciones</span>
              </motion.div>
            </motion.div>
          </div>
        </div>
