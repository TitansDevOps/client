...
//   return (
//     <section id="contact" className="relative bg-white pt-20 pb-40 overflow-hidden rounded-b-[80px]">
...
//       <div className="absolute bottom-0 left-0 w-40 h-40 bg-blue-400 opacity-10 rounded-tr-full -z-10" />
//       <div className="absolute bottom-0 right-0 w-40 h-40 bg-blue-400 opacity-10 rounded-tl-full -z-10" />
...
//                 ¿Tienes preguntas o necesitas ayuda? Contáctanos por correo, teléfono o mediante el formulario.
...
//                     <button type="button" className="flex-1 py-2 px-4 bg-blue-50 text-blue-600 rounded-full text-sm font-medium hover:bg-blue-100 transition-colors">
//                       Adopción
//                     </button>
//                     <button type="button" className="flex-1 py-2 px-4 bg-orange-50 text-orange-600 rounded-full text-sm font-medium hover:bg-orange-100 transition-colors">
//                       Donación
//                     </button>
//                     <button type="button" className="flex-1 py-2 px-4 bg-gray-50 text-gray-600 rounded-full text-sm font-medium hover:bg-gray-100 transition-colors">
//                       Otro
//                     </button>
//                   </div>
//                 </div>
...
//             >
//               <h3 className="text-xl font-bold text-gray-800 mb-4">Otras formas de contacto</h3>
