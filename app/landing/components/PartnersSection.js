      ...
      <div className="container mx-auto px-4">
        ...
        >
          {[
            {
              quote:
                "Colaborar con AdoptaTuMascota nos ha permitido ayudar a más animales necesitados.",
              author: "María Gómez",
              role: "Directora de VetCare",
            },
            {
              quote:
                "Juntos hemos logrado encontrar hogares para cientos de mascotas abandonadas.",
              author: "Carlos Rodríguez",
              role: "CEO de PetFood",
            },
            {
              quote:
                "La pasión por el bienestar animal nos une en esta maravillosa causa.",
